export default {
  name: 'Ciencia',
  items: [
    { id: 'maryam', image: './data/ciencia/images/figure1.png', bgColor: '#ffffff' },
    { id: 'curie', image: './data/ciencia/images/figure2.png', bgColor: '#ffffff' },
    { id: 'rosalind', image: './data/ciencia/images/figure3.png', bgColor: '#ffffff' },
    { id: 'hipatia', image: './data/ciencia/images/figure4.png', bgColor: '#ffffff' },
